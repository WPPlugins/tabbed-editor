...
if ( !class_exists( 'PP_Tabbed_Editor' ) ) { 
  ...
  class PP_Tabbed_Editor {
    ...
    function add_links( $links ) {
      ...
      return array_merge( $links, array( '<a class="dashicons dashicons-admin-tools" href="' . menu_page_url( $this->plugin_slug, false ) . '" title="' . __( 'Show plugin info', 'tabbed-editor' ) . '"></a>', '<a class="dashicons dashicons-star-filled" href="https://wordpress.org/support/plugin/' . $this->plugin_slug . '/reviews/" title="' . __( 'Please rate plugin', 'tabbed-editor' ) . '"></a>' ) );
   ...
   /**
    ...
    function showadmin() {
      ?>
      <div class="wrap">
        <h1 id="pp-plugin-info-tabbed-editor"><?php echo $this->plugin_name; ?> <?php _e( 'Settings', 'tabbed-editor' ); ?><span><a class="dashicons dashicons-star-filled" href="https://wordpress.org/support/plugin/<?php echo $this->plugin_slug; ?>/reviews/" title="<?php _e( 'Please rate plugin', 'tabbed-editor' ); ?>"></a> <a class="dashicons dashicons-wordpress" href="<?php echo $this->wp_url; ?>/" title="<?php _e( 'wordpress.org plugin directory', 'tabbed-editor' ); ?>"></a> <a class="dashicons dashicons-admin-home" href="http://petersplugins.com/" title="<?php _e( 'Author homepage', 'tabbed-editor' );?>"></a> <a class="dashicons dashicons-googleplus" href="http://g.petersplugins.com/" title="<?php _e( 'Authors Google+ Page', 'tabbed-editor' ); ?>"></a> <a class="dashicons dashicons-facebook-alt" href="http://f.petersplugins.com/" title="<?php _e( 'Authors facebook Page', 'tabbed-editor' ); ?>"></a> <a class="dashicons dashicons-editor-help" href="http://wordpress.org/support/plugin/<?php echo $this->plugin_slug; ?>/" title="<?php _e( 'Support', 'tabbed-editor'); ?>"></a> <a class="dashicons dashicons-admin-comments" href="http://petersplugins.com/contact/" title="<?php _e( 'Contact Author', 'tabbed-editor' ); ?>"></a></span></h1>
        <?php settings_errors(); ?>
